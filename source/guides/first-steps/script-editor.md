...
- Note that you also need [.NET Core 3.1+](https://dotnet.microsoft.com/download/dotnet-core/3.1). This is used to power tools like automatic script checking and meta validation.
