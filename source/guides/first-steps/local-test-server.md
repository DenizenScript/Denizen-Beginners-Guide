...
- **Step 0: Install Java.** You might not already have Java installed on your PC - if not, you'll need to have it installed. You can download [OpenJDK 16 from here](https://adoptopenjdk.net/). <span class="parens">(for Linux/Mac, just google how to download OpenJDK 16 for your specific OS/Distro)</span>.
